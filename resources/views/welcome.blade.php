        ...
        <div class="container">
            ...
            <div class="row text-center mt-4">
                <div class="col-md-4 mb-3 mb-md-0">
                    <div class="p-3 rounded border stat-box">
                        <h3 class="fw-bold mb-1 text-white">{{ $stats['users'] }}</h3>
                        <p class="mb-0 text-secondary">Pelanggan Terdaftar</p>
                    </div>
                </div>
                <div class="col-md-4 mb-3 mb-md-0">
                    <div class="p-3 rounded border stat-box">
                        <h3 class="fw-bold mb-1 text-white">{{ $stats['items'] }}</h3>
                        <p class="mb-0 text-secondary">Sesi Booking Bulanan</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="p-3 rounded border stat-box">
                        <h3 class="fw-bold mb-1 text-white">{{ $stats['uptime'] }}</h3>
                        <p class="mb-0 text-secondary">Kepuasan Pelanggan</p>
                    </div>
                </div>
            </div>
        </div>
