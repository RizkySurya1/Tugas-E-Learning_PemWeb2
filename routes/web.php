...
Route::prefix('bookings')->group(function () {
    Route::get('/', [ReportController::class, 'bookingIndex'])->name('bookings.index');
    Route::get('/export-excel', [ReportController::class, 'bookingExportExcel'])->name('bookings.export-excel');
    Route::get('/export-pdf', [ReportController::class, 'bookingExportPdf'])->name('bookings.export-pdf');
});

// Service Package Routes
Route::prefix('packages')->group(function () {
    Route::get('/', [ReportController::class, 'packageIndex'])->name('packages.index');
    Route::get('/export-excel', [ReportController::class, 'packageExportExcel'])->name('packages.export-excel');
    Route::get('/export-pdf', [ReportController::class, 'packageExportPdf'])->name('packages.export-pdf');
});

// Studio Rooms Routes
Route::prefix('rooms')->group(function () {
    Route::get('/', [ReportController::class, 'roomIndex'])->name('rooms.index');
    Route::get('/export-pdf', [ReportController::class, 'roomExportPdf'])->name('rooms.export-pdf');
});
